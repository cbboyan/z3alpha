...
BASIC_PARAMS = {
    # "smt"
    10: {"random_seed": [i * 100 for i in range(6)]},
    # "simplify"
    20: {
        "elim_and": [
            "true",
            "false",
        ],  # z3-qfbv z3-qfnia z3-qfnra-nlsat z3-qflia z3-qflra fast-qfnia fast-qfbv fast-qfnra
        "blast_distinct": [
            "true",
            "false",
        ],  # z3-qfbv z3-qfnia z3-qfnra-nlsat z3-qflia z3-qflra fast-qfnia fast-qfbv fast-qfnra
    ...
    # },
    # "nla2bv"
    5: {"nla2bv_max_bv_size": [4, 8, 16, 32, 64, 128]},
    # "qfnra-nlsat"
    11: {
...
def create_params_dict(logic):
    ...
    if logic == "default":
        ...
        params[20]["hoist_mul"] = [
            "true",
            "false",
        ]  # z3-qfbv z3-qfnia fast-qfnia fast-qfbv fast-qfnra
        # for qfbv
